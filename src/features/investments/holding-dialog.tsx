      ...
      <DialogContent>
        ...
        <form action={action} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor={`${id}-isin`}>ISIN (opcional)</Label>
              <Input
                id={`${id}-isin`}
                name="isin"
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor={`${id}-asset_class`}>Clase de activo</Label>
            <Select
              name="asset_class"
              value={assetClass}
            ...
            >
              <SelectTrigger id={`${id}-asset_class`} className="w-full">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {ASSET_CLASSES.map((a) => (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <Label htmlFor={`${id}-sector`}>Sector (opcional)</Label>
              <Input
                id={`${id}-sector`}
                name="sector"
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor={`${id}-geography`}>Geografía (opcional)</Label>
              <Input
                id={`${id}-geography`}
                name="geography"
          ...
          <div className="flex flex-col gap-2">
            <Label htmlFor={`${id}-current_price`}>Precio actual (opcional)</Label>
            <Input
              id={`${id}-current_price`}
              name="current_price"
              type="number"
